      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          comentarios.map(comentario => (
            <div 
              key={comentario.id} 
              className={`bg-gray-900 border ${comentario.visivel ? 'border-gray-800' : 'border-amber-500/30'} rounded-lg p-4 transition-all ${!comentario.visivel && 'bg-amber-950/10'}`}
            >
