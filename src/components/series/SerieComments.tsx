            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <Textarea 
                  ...
                  className="bg-gray-800/70 border-gray-700 rounded-lg p-3 text-white resize-none h-20 placeholder:text-gray-500 focus:ring-movieRed/40 focus:border-movieRed/50"
                />
          ...
          <Alert className="bg-gray-800/50 border-gray-700 text-white">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <AlertDescription className="text-gray-300 text-center sm:text-left">
                Faça login para deixar seu comentário nesta série
              </AlertDescription>
              <Button 
        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            Array(3).fill(0).map((_, i) => (
              <div key={i} className="bg-gray-800/40 rounded-lg p-4 animate-pulse">
                <div className="flex items-start gap-3">
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-400">Seja o primeiro a comentar sobre esta série!</p>
            </div>
          ) : (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {editandoId === comentario.id ? (
                      ...
                      <p className="text-gray-300 mt-1.5 break-words whitespace-pre-wrap">
                        {comentario.texto}
                      </p>
                    )}
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-3">
                      <Button 
                        ...
                        className={`text-sm flex items-center gap-1.5 hover:bg-gray-700 ${
                          comentario.curtido_pelo_usuario ? 'text-red-400' : 'text-gray-400'
                        }`}
                      ...
                      {comentario.usuario_id === perfilUsuario?.id && editandoId !== comentario.id && (
                        <>
                          <Button 
                            ...
                            className="text-sm flex items-center gap-1.5 text-gray-400 hover:bg-gray-700 hover:text-white"
                          >
                          ...
                          <Button 
                            ...
                            className="text-sm flex items-center gap-1.5 text-gray-400 hover:bg-gray-700 hover:text-red-400"
                        ...
                        <>
                          <Button 
                            ...
                            className={`text-sm flex items-center gap-1.5 ${
                              comentario.visivel
                                ? 'text-amber-400 hover:bg-gray-700 hover:text-amber-500'
                                : 'text-green-400 hover:bg-gray-700 hover:text-green-500'
                            }`}
                          ...
                          >
                            ...
                            {comentario.visivel ? 'Ocultar' : 'Mostrar'}
                          </Button>
